...
(function () {
  ...
  async function bootstrap() {
    ...
    const [products, ownProducts, conversations, leads, dashboard, leadCredit, buyerQuoteManager] = await Promise.all([
    ...
    return { signedIn: true, account, categories, products, ownProducts, orders: [], conversations, leads, dashboard, leadCredit, buyerQuoteManager };
  }
